          ...
          <div class="col-md-6 mx-auto">
            <form action="index.php?do=enter-true" method="POST" autocomplete="off">
              ...
              <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary" name="enter" disabled>Đăng nhập</button>
              </div>
            </form>
          </div>
        </div>
...
<?php
    ...
    if (isset($_POST['enter'])) {
      ...
      if ($count > 0) {
        ...
        show_message('Xin lỗi, bạn phải đảm bảo rằng thông tin nhập vào là chính xác', 'danger');
