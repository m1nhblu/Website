...
?>
    <div class="products">
      <div class="container">
        <h1>Sản phẩm&nbsp;<a class="btn btn-outline-primary" href="./edit-products.php?do=add-new">Thêm mới</a></h1>
                  ...
                  <td>
                    <form action="./edit-products.php?do=action" method="post">
                      ...
                      <div class="d-grid gap-2 d-md-block">
                        ...
                        <a href="../product.php?id=<?php echo $product['id']; ?>" target="_blank" class="btn btn-info"><i class="fa-solid fa-eye"></i>&nbsp;Xem</a>
  ...
  ?>
    ...
    ?>
      <div class="add-new">
        <div class="container">
          <a class="btn btn-light my-2" href="./edit-products.php"><i class="fa fa-backward" aria-hidden="true"></i>&nbsp;Quay lại</a>
          <div class="row">
            <div class="col-md-4">
