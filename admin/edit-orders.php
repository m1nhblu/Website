...
?>
    <div class="orders">
      <div class="container">
        <h1>Đơn hàng&nbsp;<a class="btn btn-outline-primary" href="./edit-orders.php?do=add-new">Thêm mới</a></h1>
                  ...
                  <td>
                    <form action="./edit-orders.php?do=action" method="post">
                      ...
                      <div class="d-grid gap-2 d-md-block">
                        ...
                        <button type="submit" class="btn btn-info" name="btn_view"><i class="fa-solid fa-eye"></i>&nbsp;Xem</button>
  ...
  ?>
          ...
          <form method="POST" action="./edit-orders.php?do=orders-true" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
              <select class="form-select text-capitalize" name="order_status">
                <option selected>Chờ thanh toán</option>
                <?php
    ...
    ?>
      <div class="edit-order">
        <div class="container">
          <a class="btn btn-light my-2" href="./edit-orders.php"><i class="fa fa-backward" aria-hidden="true"></i>&nbsp;Quay lại</a>
          <div class="col-md-6 mx-auto">
            <h1>Sửa đơn hàng : <?php echo $edit['orders_number'] . ' - ' . $edit['name_customer']; ?></h1>
      ...
      <div class="view-order">
        <div class="container">
          ...
          <div class="col-md-8 mx-auto">
            <h1>Đơn hàng <?php echo $view['orders_number'] ?> - 
              <strong class="p-1 text-capitalize rounded <?php
