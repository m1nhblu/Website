...
?>
  <div class="product-list">
    <div class="container">
      <a class="btn btn-light my-2" href="./index.php"><i class="fa fa-backward" aria-hidden="true"></i>&nbsp;Quay lại</a>
      <div class="row g-3">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
          ...
          <h2>Giá: <?php echo $product['price_product'] . ' ' . $product['currency']; ?></h2>
          <p class="fw-bold">
